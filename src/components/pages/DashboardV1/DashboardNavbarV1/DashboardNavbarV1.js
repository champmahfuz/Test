...
import styles from './DashboardNavbarV1.module.css';
import Typography from "@mui/material/Typography";
import defaultUser from "../../../../assets/img/no image.jpg";
                        ...
                        <NavDropdown title={<AccountCircleIcon />} className={`${styles.usersProfileDropdown}`}>
                            <div className={`${styles.alldropdownItems}`}>
                                ...
                                <NavDropdown.Item className={`${styles.usersDropdown}`}>
                                    ...
                                    <span className="">
                                        {" "}
                                        {user.displayName} | {true ? "User" : "Subscriber"}
                                    </span>
                                </NavDropdown.Item>
                ...
                <Modal.Body style={{ backgroundColor: "rgb(237, 235, 255)" }}>
                    <Row style={{ margin: 0 }}>
                        <Col md={6} sm={12} style={{ padding: "20px" }}>
                            <h4 style={{ textAlign: "center", color: "#003366", fontWeight: "700", marginBottom: "30px" }}>{user?.displayName}</h4>
                            {true && (
                        ...
                        <Col md={6} sm={12} style={{ backgroundColor: "#003366", padding: "20px", color: "white", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }} >
                            ...
                            <h6 className={`${styles.employeeTitle}`} >Email<span className={`${styles.employeeInfo}`}><br />{user.email}</span><hr /></h6>
...
export default DashboardNavbarV1;