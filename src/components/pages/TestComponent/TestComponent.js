...
const TestComponent = () => {
    ...
    const { setPassengerAndClassOpen, orDiInfo, flightType, setFlightType, cities, setCities } = useValue({});
                    ...
                    <Grid container spacing={ 1 } key={ index } sx={ { my: .5 } }>
                        ...
                        <Grid item xs={ 12 } md={ flightType === 'multiCity' ? 3 : 4.5 } >
                            <Grid container spacing={ 0 }>
                                <Grid item xs={ 12 } sm={ 6 } md={ flightType === 'multiCity' ? 12 : 6 } sx={ { position: 'relative' } }>
                        ...
                        <Grid item xs={ 12 } md={ flightType === 'multiCity' ? 3 : 2.5 } sx={ {} }>
