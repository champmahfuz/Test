    ...
    return (
        <Container sx={{ width: "100%", mb: 5 }}>
            <Box className={`${styles.topContainer}`} sx={{ display: "flex", my: 3 }}>
                ...
                <Typography>
                    <span style={{ fontSize: "26px" }}>All Bookings</span>{" "}
                    <br /> <span style={{ color: "#969494" }}>Boolings List</span>
                </Typography>
            </Box>
                ...
                <Box className={`${styles.tableContainer}`}>
                    <form onSubmit={handleProductSearch}>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                            ...
                            <TextField onChange={(event) => setInputValue(event.target.value)} size="small" id="outlined-basic" label="Bookings" sx={{ mr: 1 }} variant="outlined" />
